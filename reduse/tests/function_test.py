...
class TaskDependencyTestCase(unittest.TestCase):
    ...
    def test_no_broken_dependency(self):
        task = {
            "ansible.builtin.dnf-key": {"url": "https://example.com/key.rpm"},
            "package_facts": {},
            "debug": {},
            "when": {},
        }
...
class TaskPackageTestCase(unittest.TestCase):
    ...
    def test_multiple_packages(self):
        ...
        result = detector.check_task_for_outdated_package(task)
        expected_result = (
            "Task uses apt to install the latest packages.\n"
...
class TaskIdempotencyTestCase(unittest.TestCase):
    def test_command(self):
        ...
        self.assertEqual(
            result, "Task violates idempotency because it executes a command."
        )
    ...
    def test_apt(self):
        ...
        self.assertEqual(
            result,
            "Task violates idempotency because it installs or upgrades packages with apt.",
        )
    ...
    def test_yum(self):
        ...
        self.assertEqual(
            result,
            "Task violates idempotency because it installs or upgrades packages with yum.",
        )
    ...
    def test_dnf(self):
        ...
        result = detector.check_task_for_idempotency(task)
        self.assertEqual(
            result, "Task violates idempotency because it installs packages with dnf."
        )
    ...
    def test_pacman(self):
        ...
        self.assertEqual(
            result,
            "Task violates idempotency because it installs packages with pacman.",
        )
    ...
    def test_pip(self):
        ...
        result = detector.check_task_for_idempotency(task)
        self.assertEqual(
            result, "Task violates idempotency because it installs packages with pip."
        )
    ...
    def test_firewall_no_state(self):
        ...
        result = detector.check_task_for_idempotency(task)
        self.assertEqual(
            result, "Task changes the state of the firewall without checking."
        )
...
class TaskVersionSpecificPackageTestCase(unittest.TestCase):
    def test_apt_with_version(self):
        ...
        self.assertEqual(
            result, "Task uses apt to install a specific version of a package."
        )
    ...
    def test_yum_with_version(self):
        ...
        result = detector.check_task_for_version_specific_package(task)
        self.assertEqual(
            result, "Task uses yum to install a specific version of a package."
        )
    ...
    def test_dnf_with_version(self):
        ...
        result = detector.check_task_for_version_specific_package(task)
        self.assertEqual(
            result, "Task uses dnf to install a specific version of a package."
        )
    ...
    def test_pacman_with_version(self):
        ...
        result = detector.check_task_for_version_specific_package(task)
        self.assertEqual(
            result, "Task uses pacman to install a specific version of a package."
        )
    ...
    def test_apk_with_version(self):
        ...
        result = detector.check_task_for_version_specific_package(task)
        self.assertEqual(
            result, "Task uses apk to install a specific version of a package."
        )
    ...
    def test_pip_with_version(self):
        ...
        result = detector.check_task_for_version_specific_package(task)
        self.assertEqual(
            result, "Task uses pip to install a specific version of a package."
        )
...
class TaskSoftwareSpecificCommandsTestCase(unittest.TestCase):
    ...
    def test_software_specific_command_kubectl(self):
        ...
        result = detector.check_task_for_software_specific_commands(task)
        self.assertEqual(
            result, "Task uses a kubectl command that may not be portable."
        )
