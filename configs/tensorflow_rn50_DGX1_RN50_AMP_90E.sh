...
mpiexec --allow-run-as-root ${BIND_TO_SOCKET} -np 1 python3 main.py --arch=resnet50 \
    --mode=training_benchmark --iter_unit=epoch --num_iter=4 --run_iter 2 \
    --batch_size=32 --use_cosine --label_smoothing 0.1 \
