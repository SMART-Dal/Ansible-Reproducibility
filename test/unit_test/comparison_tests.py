...
class MainMethodTest(unittest.TestCase):
    ...
    def test_main_method_1(self):
        file_path = os.path.abspath('../testScripts/Repository1/main.yml')

        expected_csv_file = os.path.abspath('../src/output/expected_main.yml_smells_v1.csv')
    ...
    def test_main_method_2(self):
        ...
        pd.main_method(file_path)
        actual_output = os.path.abspath('../src/output/setup-Archlinux.yml_smells_v1.csv')
        self.assertCsvFilesEqual(actual_output, expected_csv_file)
